...
class Exercise(models.Model):
    # Existing fields...
    rubric_criteria1 = models.IntegerField(null=True, blank=True)  # Example rubric field 1
    rubric_criteria2 = models.IntegerField(null=True, blank=True)  # Example rubric field 2
    # Add more rubric fields as needed
